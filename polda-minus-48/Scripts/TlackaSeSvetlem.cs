...
public partial class TlackaSeSvetlem : Button
{
	...
	public override void _Ready()
	{
		...
		Pressed +=  _on_zhasnout_svetlo_pressed;
		Pressed += _on_podivne_svitici_zarivka_pressed;
		Pressed += _on_podivat_se_z_okna_pressed;
	}
	...
	private void _on_zhasnout_svetlo_pressed()
	{
		...
		if (!zhasnuto == false)
		{
			GetNode<Sprite2D>("../Room1_Rosviceno").Hide();	//.. - zkratka pro node
